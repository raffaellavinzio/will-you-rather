      ...
      <div className='user'>
        <div className="user-body">
          ...
          <div > 
            ...
            <p className="user-counter"><span className="user-count">{answers}</span> answered questions </p>
            <p className="user-counter"><span className="user-count">{questions}</span> created questions </p>
          </div>
